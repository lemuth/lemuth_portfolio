...
import { pictureListe } from "../Data/picturesArray";
                                ...
                                return(
                                    <Link key={item.id} href={{pathname: '/ImageViewer', query: {id:item.id}}} className="flex justify-center items-center bg-transparent hover:bg-yellowTheme">
                                        <div className="relative inline-block p-2">
                                            <Image width={item.widthMin} height={item.heightMin} src={item.path} alt={item.prez} draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
