                ...
                <div className="flex flex-wrap items-stretch justify-center">
                    <Link href={{pathname: '/ImageViewer', query: {id:0}}} className="flex justify-center items-center bg-white hover:bg-yellowTheme">
                        <div className="relative inline-block p-2">
                            <Image width={256} height={194} src="/lemuth_portfolio/images/TP-street_project.jpg" alt="cyberStreet" draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
                    ...
                    <Link href={{pathname: '/ImageViewer', query: {id:1}}} className="flex justify-center items-center bg-white hover:bg-yellowTheme">
                        <div className="relative inline-block p-2">
                            <Image width={256} height={194} src="/lemuth_portfolio/images/TeakCell-vue-interieur-final.jpg" alt="tekCellInt" draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
                            <div className="absolute top-0 left-0 w-full h-full bg-[rgba(255, 255, 255, 0)]" />
                        </div>
                    </Link>
                    <Link href={{pathname: '/ImageViewer', query: {id:2}}} className="flex justify-center items-center bg-white hover:bg-yellowTheme">
                        <div className="relative inline-block p-2">
                            <Image width={356} height={194} src="/lemuth_portfolio/images/TeakCell-vue exterieur-final.jpg" alt="tekCellExt" draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
                            <div className="absolute top-0 left-0 w-full h-full bg-[rgba(255, 255, 255, 0)]" />
                        </div>
                    </Link>
                    <Link href={{pathname: '/ImageViewer', query: {id:3}}} className="flex justify-center items-center bg-white hover:bg-yellowTheme">
                        <div className="relative inline-block p-2">
                            <Image width={259} height={194} src="/lemuth_portfolio/images/MTF-filaire.jpg" alt="mecha" draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
                            <div className="absolute top-0 left-0 w-full h-full bg-[rgba(255, 255, 255, 0)]" />
                        </div>
                    </Link>
                    <Link href={{pathname: '/ImageViewer', query: {id:4}}} className="flex justify-center items-center bg-white hover:bg-yellowTheme">
                        <div className="relative inline-block p-2">
                            <Image width={259} height={194} src="/lemuth_portfolio/images/TP-street_in_fire.jpg" alt="leftfordead" draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
                            <div className="absolute top-0 left-0 w-full h-full bg-[rgba(255, 255, 255, 0)]" />
                        </div>
                    </Link>
                    <Link href={{pathname: '/ImageViewer', query: {id:5}}} className="flex justify-center items-center bg-white hover:bg-yellowTheme">
                        <div className="relative inline-block p-2">
                            <Image width={274} height={194} src="/lemuth_portfolio/images/CM-moonoeuf-02.jpg" alt="cmMoonOeuf" draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
                            <div className="absolute top-0 left-0 w-full h-full bg-[rgba(255, 255, 255, 0)]" />
                        </div>
                    </Link>
                    <Link href={{pathname: '/ImageViewer', query: {id:6}}} className="flex justify-center items-center bg-white hover:bg-yellowTheme">
                        <div className="relative inline-block p-2">
                            <Image width={343} height={194} src="/lemuth_portfolio/images/CM-vestiaire-01.jpg" alt="cmVestiaire" draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
                            <div className="absolute top-0 left-0 w-full h-full bg-[rgba(255, 255, 255, 0)]" />
                        </div>
                    </Link>
                    <Link href={{pathname: '/ImageViewer', query: {id:7}}} className="flex justify-center items-center bg-white hover:bg-yellowTheme">
                        <div className="relative inline-block p-2">
                            <Image width={343} height={194} src="/lemuth_portfolio/images/CM-bureau-02.jpg" alt="moonersDesk" draggable="false" className="shadow-[8px_10px_16px_rgba(0,0,0,0.35)]" />
                            <div className="absolute top-0 left-0 w-full h-full bg-[rgba(255, 255, 255, 0)]" />
                        </div>
                    </Link>
